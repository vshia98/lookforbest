<template>
  <div class="max-w-2xl mx-auto py-10 px-4">
    <h1 class="text-2xl font-bold text-white mb-2">厂商入驻申请</h1>
    <p class="text-gray-500 text-sm mb-8">填写以下信息完成厂商认证入驻，审核通过后即可管理您的机器人产品。</p>

    <!-- 已有申请状态卡片 -->
    <div v-if="existingApplication" class="bg-dark-50 rounded-xl border border-white/[0.06]  p-6">
      ...
      >
        ...
        <button
          ...
          class="mt-3 text-sm text-red-400 underline hover:text-red-900"
        >重新申请</button>
      </div>
    ...
    <!-- 申请表单 -->
    <div v-else class="bg-dark-50 rounded-xl border border-white/[0.06]  p-6">
      <form @submit.prevent="handleSubmit" class="space-y-5">
        <!-- 公司名称 -->
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">公司名称 <span class="text-red-500">*</span></label>
            <input
          ...
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">英文名称</label>
            <input
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">国家/地区 <span class="text-red-500">*</span></label>
            <select
          ...
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">官网地址</label>
            <input
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">联系人 <span class="text-red-500">*</span></label>
            <input
          ...
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">联系邮箱 <span class="text-red-500">*</span></label>
            <input
        ...
        <!-- 营业执照 -->
        <div>
          <label class="block text-sm font-medium text-gray-300 mb-1">营业执照图片 URL</label>
          <input
        ...
        <!-- 申请说明 -->
        <div>
          <label class="block text-sm font-medium text-gray-300 mb-1">申请说明</label>
          <textarea
        ...
        <!-- 错误提示 -->
        <div v-if="errorMsg" class="input-dark">
          {{ errorMsg }}
        </div>
        ...
        <button
          type="submit"
          :disabled="submitting"
          class="w-full bg-primary hover:bg-primary-400 disabled:bg-primary/40 text-[#1a1a1a] font-medium py-2.5 rounded-lg text-sm transition-colors"
        >
